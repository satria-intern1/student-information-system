<div x-data="{ showAddModal: false, }" class="mb-4 px-4 sm:px-6 lg:px-8">
    <button @click="showAddModal = true" type="button" class="text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  focus:outline-none">
        {{ $buttonText }}
    </button>
